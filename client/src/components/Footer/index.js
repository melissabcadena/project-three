    ...
    return (
        <Card className="text-center">
            ...
            <small className="text-muted">
                &copy; {new Date().getFullYear()} All Rights Reserved. Designed &amp; developed by <a href="https://github.com/d-belleza" target="blank">David
                ...
                </a> &amp; <a href="https://github.com/osadenaike" target="blank">Femi</a>
            </small>
            </CardHeader>
        </Card>
